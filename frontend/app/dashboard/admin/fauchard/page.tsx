  ...
  if (!res.success) {
    return (
      <div className="p-12 flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <h1 className="text-xl font-black text-white uppercase tracking-tighter">Error de Configuración</h1>
        <p className="text-slate-500 text-sm max-w-md text-center">{res.error}</p>
      </div>
    );
  }
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-black text-white uppercase tracking-tighter">Motor Fauchardón</h1>
          </div>
          <p className="text-slate-500 text-sm font-medium">Configura los parámetros inteligentes de asignación de técnicos.</p>
        </div>

        <div className="flex items-center gap-4 px-6 py-3 rounded-3xl bg-slate-900/40 border border-slate-800/60 shadow-xl">
          <div className="flex flex-col items-end">
            <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Versión Activa</span>
            <span className="text-sm font-black text-white">V{config.version}</span>
          </div>
          <div className="w-px h-8 bg-slate-800" />
          <div className="flex flex-col items-end">
            <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Último Cambio</span>
