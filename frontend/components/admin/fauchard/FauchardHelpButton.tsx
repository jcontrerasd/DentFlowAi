...
export default function FauchardHelpButton({ onClick, label }: FauchardHelpButtonProps) {
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary-hl px-4 py-2 text-xs font-bold uppercase tracking-wider text-primary shadow-sm transition-all hover:bg-primary hover:text-white hover:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
    >
